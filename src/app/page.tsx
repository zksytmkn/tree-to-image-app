...
import { ChangeEventHandler, ClipboardEventHandler, useRef, useState } from "react";
      ...
      <div className="grid grid-cols-3 h-screen">
        ...
        <div className="bg-zinc-800 p-6 flex items-center justify-center col-span-2">
          <div className="m-atuo w-full">
            <div ref={ref} className="bg-zinc-900 text-gray-50 relative rounded-md overflow-hidden shadow-lg">
...
const Item = ({ item }: { item: Item }) => {
  ...
  return (
    <li className="relative px-4 text-zinc-300">
      <button className="absolute inset-0" onClick={() => setHiglight((v) => !v)}></button>
      {highlight && (
